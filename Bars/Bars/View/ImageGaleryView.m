...
- (void) getAllBarImage {
    NSString *barImgDir = [Util getImageBarDir:[NSString stringWithFormat:@"%d", _bar.barID]];
...
- (void) generateScroll {
    ...
    for (int j = 0; j < [_imageLinks count]; j++) {
        ...
        NSString *fullPath = [[Util getImageBarDir:[NSString stringWithFormat:@"%d", _bar.barID]] stringByAppendingString:[NSString stringWithFormat:@"/%@", imgPath]];
