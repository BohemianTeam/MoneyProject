...
//    _addAnnotation.titleAnno = _address;
//	[_mapView addAnnotation:_addAnnotation];
	
    MyLocaAnnotation *myLoca = [[MyLocaAnnotation alloc] initWithName:self.title address:_address coordinate:location];
    [_mapView addAnnotation:myLoca];
...
- (id) initWithAddress:(NSString *)address title:(NSString*)title{
