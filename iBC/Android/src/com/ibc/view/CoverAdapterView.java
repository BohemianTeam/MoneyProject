...
public abstract class CoverAdapterView<T extends Adapter> extends ViewGroup {
	...
	public interface OnItemLongClickListener {
		...
		//boolean onItemLongClick(SDAlbumCoverFlow sdAlbumCoverFlow,
				//View mDownTouchView, int mDownTouchPosition, long id);
		
		boolean onItemLongClick(SDPlayerCoverFlow sdAlbumCoverFlow,
				View mDownTouchView, int mDownTouchPosition, long id);
	}
